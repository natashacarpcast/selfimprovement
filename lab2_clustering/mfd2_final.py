...
pca_kmeans = KMeans(k=2, seed=2503)
...
print("Silhouette with squared euclidean distance = {} when using PCA and 2 k clusters".format(str(silhouette)))
print("Predictions corresponding to PCA and 2 k clusters")
